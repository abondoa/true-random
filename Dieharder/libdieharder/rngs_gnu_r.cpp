...
/* kind Nkind	  name	           n_seed      i_seed */
    { (RNGtype)0, (N01type)0, "Wichmann-Hill", 	        3,	dummyvec},
    { (RNGtype)1, (N01type)0, "Marsaglia-MultiCarry",	2,	dummyvec},
    { (RNGtype)2, (N01type)0, "Super-Duper",		2,	dummyvec},
    { (RNGtype)3, (N01type)0, "Mersenne-Twister",	    1+624,	dummyvec},
    { (RNGtype)4, (N01type)0, "Knuth-TAOCP",          1+100,	dummyvec},
    { (RNGtype)5, (N01type)0, "User-supplied",            0,	dummyvec},
    { (RNGtype)6, (N01type)0, "Knuth-TAOCP-2002",     1+100,	dummyvec},
};
